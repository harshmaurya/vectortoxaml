...
namespace VectorToXamlConvertor.Annotations
{
  /// <summary>
  ...
  /// public void ShowMessage(string message, params object[] args) { /* do something */ }
  /// public void Foo() {
  ///   ShowMessage("Failed: {0}"); // Warning: Non-existing argument in format string
  /// }
  /// </code></example>
  [AttributeUsage(
